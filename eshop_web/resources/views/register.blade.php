                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header justify-content-center"><h3 class="fw-light my-4">Registration User</h3></div>
                                    @if($errors->any())
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{url('doregister_user')}}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="inputEmailAddress" name="user_name" type="text" placeholder="Inserisci il tuo nome" />
                                            </div>

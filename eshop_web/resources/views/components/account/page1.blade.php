                        ...
                        <div class="card-body">
                            ...
                            {{csrf_field()}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputUsername" type="text" placeholder="Enter your username" value="{{$user->user_name}}" name="user_name" />
                                </div>
                                <!-- Form Row-->
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" id="inputOrgName" type="text" placeholder="Inserisci il nome della tua Attività" value="{{$user->ragsoc}}" name="ragsoc" />
                                    </div>
                                </div>
                                <div class="row gx-3 mb-3">
                                    <!-- Form Group (organization name)-->
